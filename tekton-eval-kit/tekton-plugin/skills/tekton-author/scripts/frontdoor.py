...
"""frontdoor.py -- THE MULTI-SURFACE FRONT DOOR: ONE entrypoint, THREE inputs.
    ...
    frontdoor author --prompt "an electrical room 30x20 ft rated for 2500 A service \\
        ...
        [--out DIR] [--strict] [--handoff-only] [--target-version {2026,2025}]
...
def build_parser() -> argparse.ArgumentParser:
    ...
    pol.add_argument("--target-version", type=int, choices=(2026, 2025), default=None,
                     metavar="{2026,2025}",
                     help="the Revit release the RECIPIENT runs (ASK the user first -- Revit "
                          ...
                          "2025 = resolve the Revit-2025 genesis base when its campaign "
                          "certifies; until then the build DELIVERS the 2026 file plus one "
                          "clear line and a version-agnostic IFC addition -- never a silent "
                          "2026 file presented as 2025")
