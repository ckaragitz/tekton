...
__all__ = [
    ...
    "compose_placement", "axis2placement3d_matrix", "analyze_product",
...
class Placement:
    ...
    matrix: np.ndarray                     # 4x4 absolute (project length units)
    ...
    def as_json(self, scale_m: float = 1.0) -> dict:
        return {
            "absolute_origin_m": _vf(self.origin * scale_m),
            "absolute_xdir": _vf(self.matrix[:3, 0]),
            "absolute_zdir": _vf(self.matrix[:3, 2]),
