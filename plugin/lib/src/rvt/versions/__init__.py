...
KNOWN_RELEASES: Dict[int, Release] = {
    ...
    # 2023: the first release in the roster whose RECORD LAYER differs --
    # element ids are 32-bit (the schema's own declaration: Identifier v1
    # ``m_id`` i32; 2024+ is v2 ``m_id64`` i64).  Reading a 2023 file needs
    # BOTH this framing table AND rvt.versions.records32 (use
    # ``records32.reading32(path)``, which activates the width layer iff the
    # file's schema declares Identifier v1).  Registered by the
    # genesis-2023-reduce stream, 2026-08-04.
    2023: Release(
        year=2023, schema_size=462_765,
        schema_sha256="bce7907bbb970c0e4fa6bfea3f0683898a494f1a75b44b543043bc98babfaa95",
        class_count=4418, sample_build="20220401_1515(x64)",
        framing={"BLOCK_TAG": 0x0E4E, "TRAILER_TAG": 0x0E47, "FOOTER_TAG": 0x0E61,
                 "CONTAINER_CLASS": 0x0365, "UNIT_INNER_CLASS": 0x0364,
                 "PT_CLASS": 0x0BC0},
        anchors={"ADocument": 0x1C, "Element": 0x25, "ElementId": 0x14,
                 "ElemTable": 0x55A, "ElemRec": 0x556, "GraveyardRec": 0x55B,
                 "DocumentHistory": 0x4DC, "DocumentIncrementTable": 0x4E0,
                 "DocumentStorageIndexImpl": 0x4E2, "ElementHeader": 0x576,
                 "GElement": 0x819, "SerializedDummy": 0xE52, "GStyleElem": 0x845,
                 "CategoryElem": 0x2AB, "ESSchemaStorage": 0x510, "HostObj": 0x192,
                 "Level": 0x949, "SWall": 0xE29, "FamilyInstance": 0x740,
                 "FamilySymbol": 0x762, "Symbol": 0x6B, "XYZ": 0xAC, "UV": 0x71F},
        samples_dir="samples/2023", creation_certified=False),
}
...
#: 2026 alone (docs/writer/genesis-2025-plan.md is the 2025 campaign; the
#: 2024 campaign mirrors it -- the recipe transfers across releases,
#: genesis-audit verdict #28).
    ...
    if r is not None:
        return {"target": target, "supported": False, "base": None,
                ...
                "reason": (f"no certified Revit {target} genesis base yet: creating a "
                           ...
                           f"docs/writer/genesis-2025-plan.md (the per-release campaign "
                           f"template -- the recipe transfers across releases, "
                           f"genesis-audit verdict #28)")}
    return {"target": target, "supported": False, "base": None,
