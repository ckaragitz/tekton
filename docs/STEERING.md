...
| S-2026-08-10-a | 2026-08-10 | ck (via clkaragitz session) | Generated families carry the view set a Revit-born family carries — the Ref. Level plan, the ceiling plan, the four elevations and the "View 1" 3D view — from now on: every family factory goes through the shared view constellation, and a family without them is incomplete, not "minimal". | #381 |
