...
| S-2026-08-09-f | 2026-08-09 | ck | Work is pulled from one shared, ordered queue and locked at pull time — per session, not just per login — and every claim is verified before it is confirmed; nobody assigns stories, and a session never resumes an issue another live session is visibly working. | #90 |
