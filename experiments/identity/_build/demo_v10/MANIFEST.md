...
**Tool:** tekton frontdoor (rvt.frontdoor) v1.0.0 · 2026-08-05T17:34:13Z
...
- feeder edges: 0
- intent JSON: `experiments/identity/_build/demo_v10/intent.json`
...
- file **combined**: `experiments/identity/_build/demo_v10/DEMO_250v_room_v10.rvt` (1216512 bytes, sha256 `58386d246174239a…`)
...
- entrypoint: `python tools/frontdoor.py author --rvt experiments/identity/_build/demo_v10/DEMO_250v_room_v10.rvt --edit "<sentence | ops.json | inline JSON>" --out <dir>`
