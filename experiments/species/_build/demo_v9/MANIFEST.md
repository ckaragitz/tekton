...
**Tool:** tekton frontdoor (rvt.frontdoor) v1.0.0 · 2026-08-05T16:58:03Z
...
- feeder edges: 0
- intent JSON: `experiments/species/_build/demo_v9/intent.json`
...
- file **combined**: `experiments/species/_build/demo_v9/DEMO_250v_room_v9.rvt` (1216512 bytes, sha256 `130e961881c20ec2…`)
...
- entrypoint: `python tools/frontdoor.py author --rvt experiments/species/_build/demo_v9/DEMO_250v_room_v9.rvt --edit "<sentence | ops.json | inline JSON>" --out <dir>`
