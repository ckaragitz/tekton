...
**Tool:** tekton frontdoor (rvt.frontdoor) v1.0.0 · 2026-08-05T05:02:26Z
...
- feeder edges: 0
- intent JSON: `experiments/instbug/fix/demo_v2/intent.json`
...
- file **combined**: `experiments/instbug/fix/demo_v2/DEMO_250v_room_v2.rvt` (638976 bytes, sha256 `0b20fd500b63a93e…`)
...
- entrypoint: `python tools/frontdoor.py author --rvt experiments/instbug/fix/demo_v2/DEMO_250v_room_v2.rvt --edit "<sentence | ops.json | inline JSON>" --out <dir>`
