...
**Tool:** tekton frontdoor (rvt.frontdoor) v1.0.0 · 2026-08-05T09:53:27Z
...
- feeder edges: 0
- intent JSON: `experiments/frontdoor/demo-250v-v5/intent.json`
...
- scene_brief: `experiments/frontdoor/demo-250v-v5/scene-brief.json`
- handoff: `experiments/frontdoor/demo-250v-v5/HANDOFF.md`
- instructions: `experiments/frontdoor/demo-250v-v5/PROMPT_TO_IFC.md`
...
- file **combined**: `experiments/frontdoor/demo-250v-v5/prompt_room.rvt` (638976 bytes, sha256 `9d9d157dd9ee9db8…`)
...
- entrypoint: `python tools/frontdoor.py author --rvt experiments/frontdoor/demo-250v-v5/prompt_room.rvt --edit "<sentence | ops.json | inline JSON>" --out <dir>`
- `PP-1` (id 1472879, equipment-instance): move: `move PP-1 to X,Y,Z ft`; retype: `retype PP-1 to <symbol id>`; delete: `delete PP-1 with cascade`
- `PP-2` (id 1472880, equipment-instance): move: `move PP-2 to X,Y,Z ft`; retype: `retype PP-2 to <symbol id>`; delete: `delete PP-2 with cascade`
- `PP-3` (id 1472881, equipment-instance): move: `move PP-3 to X,Y,Z ft`; retype: `retype PP-3 to <symbol id>`; delete: `delete PP-3 with cascade`
- `PP-4` (id 1472882, equipment-instance): move: `move PP-4 to X,Y,Z ft`; retype: `retype PP-4 to <symbol id>`; delete: `delete PP-4 with cascade`
- `PP-5` (id 1472883, equipment-instance): move: `move PP-5 to X,Y,Z ft`; retype: `retype PP-5 to <symbol id>`; delete: `delete PP-5 with cascade`
- `PP-6` (id 1472884, equipment-instance): move: `move PP-6 to X,Y,Z ft`; retype: `retype PP-6 to <symbol id>`; delete: `delete PP-6 with cascade`
