...
**Tool:** tekton frontdoor (rvt.frontdoor) v1.0.0 · 2026-08-05T16:18:18Z
...
- feeder edges: 0
- intent JSON: `experiments/selfcontained/_build/demo_v8/intent.json`
...
- file **combined**: `experiments/selfcontained/_build/demo_v8/DEMO_250v_room_v8.rvt` (1216512 bytes, sha256 `2507e59bdf154f01…`)
...
- entrypoint: `python tools/frontdoor.py author --rvt experiments/selfcontained/_build/demo_v8/DEMO_250v_room_v8.rvt --edit "<sentence | ops.json | inline JSON>" --out <dir>`
