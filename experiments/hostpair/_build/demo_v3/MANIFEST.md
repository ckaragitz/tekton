...
**Tool:** tekton frontdoor (rvt.frontdoor) v1.0.0 · 2026-08-05T08:04:55Z
...
- feeder edges: 0
- intent JSON: `experiments/hostpair/_build/demo_v3/intent.json`
...
- file **combined**: `experiments/hostpair/_build/demo_v3/DEMO_250v_room_v3.rvt` (638976 bytes, sha256 `f669b9cdf71c8f19…`)
...
- entrypoint: `python tools/frontdoor.py author --rvt experiments/hostpair/_build/demo_v3/DEMO_250v_room_v3.rvt --edit "<sentence | ops.json | inline JSON>" --out <dir>`
