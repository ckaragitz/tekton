...
**Tool:** tekton frontdoor (rvt.frontdoor) v1.0.0 · 2026-08-05T04:29:16Z
...
## Input
- **ifc**: `/Users/ck/dev/things/tekton/experiments/routes/demo3-prompt-via-ifc-rvt/prompt_intent.ifc`
...
- room `Electrical Room room shell`: 4 walls (0 synthesized), 0 doors
- equipment (7): switchboard×1, distribution_panelboard×2, lighting_panelboard×4
- family plans: house 1, resolved 6
- feeder edges: 7
- intent JSON: `experiments/routes/demo3-prompt-via-ifc-rvt/intent.json`
...
- file **combined**: `experiments/routes/demo3-prompt-via-ifc-rvt/prompt_intent.rvt` (651264 bytes, sha256 `55da635ae7f5322e…`)
...
- entrypoint: `python tools/frontdoor.py author --rvt experiments/routes/demo3-prompt-via-ifc-rvt/prompt_intent.rvt --edit "<sentence | ops.json | inline JSON>" --out <dir>`
